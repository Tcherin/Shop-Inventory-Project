...
video_2 = Video("Titanic", "Romance", "Everyone enjoys an ice-bucket challenge.", 20, 2, 5, supplier_1)
video_repository.save(video_2)
video_3 = Video("The Shining", "Horror", "Airbnb gone wrong.", 13, 2, 5, supplier_3)
video_repository.save(video_3)
video_4 = Video("E.T", "Kids", "Space Uber sucks.", 3, 4, 7, supplier_3)
video_repository.save(video_4)
video_5 = Video("Nightmare on Elm Street", "Horror", "Man teaches kids to believe in their dreams.", 6, 3, 6, supplier_2)
video_repository.save(video_5)
video_6 = Video("Stuart Little", "Kids", "Rich family adopts mouse instead of needy child.", 12, 3, 5, supplier_1)
video_repository.save(video_6)
video_7 = Video("Snow White", "Kids", "Man kisses unconscious woman while seven other guys watch.", 0, 5, 8, supplier_2)
video_repository.save(video_7)
video_8 = Video("The Wizard of Oz", "Kids", "Woman commits murder and meets three friends to kill again.", 4, 6, 8, supplier_1)
video_repository.save(video_8)
video_9 = Video("The Sound of Music", "Musical", "Nun bangs her boss and flees the country.", 9, 4, 6, supplier_3)
